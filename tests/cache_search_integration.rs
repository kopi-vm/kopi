...
fn create_comprehensive_test_cache() -> (TestHomeGuard, MetadataCache) {
    ...
    let temurin_packages = vec![
        JdkMetadata {
            ...
            distribution_version: "21.0.5+11".to_string(),
        ...
        JdkMetadata {
            ...
            distribution_version: "22.0.2+9".to_string(),
            architecture: Architecture::X64,
            operating_system: OperatingSystem::Linux,
            package_type: PackageType::Jdk,
            lib_c_type: Some("glibc".to_string()),
        ...
        JdkMetadata {
            ...
            distribution_version: "23+37-ea".to_string(),
            architecture: Architecture::X64,
            operating_system: OperatingSystem::Linux,
            package_type: PackageType::Jdk,
            lib_c_type: Some("glibc".to_string()),
    ...
    let corretto_packages = vec![
        JdkMetadata {
            ...
            distribution_version: "17.0.12.7.1".to_string(),
            architecture: Architecture::X64,
            operating_system: OperatingSystem::Linux,
            package_type: PackageType::Jdk,
            lib_c_type: Some("glibc".to_string()),
        ...
        JdkMetadata {
            ...
            distribution_version: "11.0.24.8.1".to_string(),
            architecture: Architecture::X64,
            operating_system: OperatingSystem::Linux,
            package_type: PackageType::Jdk,
            lib_c_type: Some("glibc".to_string()),
    ...
    let zulu_packages = vec![
        JdkMetadata {
            ...
            distribution_version: "21.0.4+7".to_string(),
            architecture: Architecture::X64,
            operating_system: OperatingSystem::Linux,
            package_type: PackageType::Jdk,
            lib_c_type: Some("glibc".to_string()),
