...
fn create_test_cache_with_lts_data() -> (TestHomeGuard, MetadataCache) {
    ...
    let sts_package = JdkMetadata {
        ...
        archive_type: ArchiveType::TarGz,
        javafx_bundled: false,
        download_url: Some("https://example.com/temurin-22.tar.gz".to_string()),
        checksum: None,
        checksum_type: Some(ChecksumType::Sha256),
        size: 210000000,
        lib_c_type: Some("glibc".to_string()),
    ...
    let ea_package = JdkMetadata {
        ...
        archive_type: ArchiveType::TarGz,
        javafx_bundled: false,
        download_url: Some("https://example.com/temurin-23.tar.gz".to_string()),
        checksum: None,
        checksum_type: Some(ChecksumType::Sha256),
        size: 215000000,
        lib_c_type: Some("glibc".to_string()),
    ...
    let jre_package = JdkMetadata {
        ...
        archive_type: ArchiveType::TarGz,
        javafx_bundled: false,
        download_url: Some("https://example.com/temurin-21-jre.tar.gz".to_string()),
        checksum: None,
        checksum_type: Some(ChecksumType::Sha256),
        size: 90000000,
        lib_c_type: Some("glibc".to_string()),
    ...
    let javafx_package = JdkMetadata {
        ...
        archive_type: ArchiveType::TarGz,
        javafx_bundled: true,
        download_url: Some("https://example.com/liberica-21-javafx.tar.gz".to_string()),
        checksum: None,
        checksum_type: Some(ChecksumType::Sha256),
        size: 250000000,
        lib_c_type: Some("glibc".to_string()),
...
fn test_compact_mode_deduplication() {
    ...
    for arch in [Architecture::X64, Architecture::Aarch64] {
        packages.push(JdkMetadata {
            ...
            archive_type: ArchiveType::TarGz,
            javafx_bundled: false,
            download_url: Some(format!("https://example.com/zulu-21-{arch}.tar.gz")),
            checksum: None,
            checksum_type: Some(ChecksumType::Sha256),
            size: 200000000,
            lib_c_type: Some("glibc".to_string()),
...
fn test_detailed_mode_deduplication_keeps_smallest() {
    ...
    for (i, size) in [(1, 300_000_000), (2, 200_000_000), (3, 250_000_000)].iter() {
        packages.push(JdkMetadata {
            ...
            archive_type: ArchiveType::TarGz,
            javafx_bundled: false,
            download_url: Some(format!("https://example.com/temurin-21-{i}.tar.gz")),
            checksum: None,
            checksum_type: Some(ChecksumType::Sha256),
            size: *size,
            lib_c_type: Some("glibc".to_string()),
