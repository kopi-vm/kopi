...
- [x] Platform smoke tests (Unix + Windows CI) for cancellation & timeout (shared coverage implemented 2025-10-22 via `tests/locking_platform_integration.rs`; CI scheduling for both platforms remains to be confirmed.)
